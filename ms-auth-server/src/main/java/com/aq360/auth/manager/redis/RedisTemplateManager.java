package com.aq360.auth.manager.redis;
...
import com.aq360.auth.common.util.CacheInvocation;
import com.aq360.auth.common.util.CompressUtil;
...
public class RedisTemplateManager<PK, T> {
	...
	public void set(PK key, T value) {
	...
	public boolean existKey(PK key) {
